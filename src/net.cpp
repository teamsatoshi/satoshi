...
static const char *strMainNetDNSSeed[][2] = {
    {"80.211.9.245", "80.211.9.245"},
	{"194.182.64.80", "194.182.64.80"},
	{"194.182.64.93", "194.182.64.93"},
	{"80.211.229.120", "80.211.229.120"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Satoshi is probably already running."), addrBind.ToString().c_str());
        else
