...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: satoshi.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: satoshid.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 23601 or testnet: 33601)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 23602 or testnet: 33602)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Satoshi Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Satoshi is probably already running."), strDataDir.c_str()));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("Satoshi version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());
